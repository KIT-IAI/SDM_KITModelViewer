...
Go to the <kbd>Web Service toolbar</kbd>, use the context menu an <kbd>Add New Web Service</kbd> with the following Url:<br>```http://tubvsig-so2sat-vm1.srv.mwn.de/geoserver/ows?SERVICE=WFS&VERSION=2.0.0```<br>
