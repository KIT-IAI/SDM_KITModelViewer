...
[GlobalBuildingAtlas](https://github.com/zhu-xlab/GlobalBuildingAtlas) provides 2D building outlines worldwide and allows access via standardized OGC WebFeatureService. This article describes how to set up the OGC web service in KITModelViewer and how to retrieve data. It also shows how to use the [GlobalBuildingAtlas BuldingCreator](https://github.com/KIT-IAI/SDM_Plugin_GlobalBuildingAtlas-BuildingCreator) plugin to create 3D buildings in CityGML format from this data.
...
Activate the “global3D:lod1_global” feature in the table and set the request type to “get”. Then use the <kbd>Bounding Box</kbd> button in the Filteroptions to apply the bounding box of the current scene. The new filter is added in the list below. Activate the filter and submit the request by pressing <kbd>OK</kbd>
