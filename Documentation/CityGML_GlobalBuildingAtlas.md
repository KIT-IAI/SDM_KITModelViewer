...
Go to the <kbd>Web Service toolbar</kbd>, use the context menu <kbd>Add New Web Service</kbd> and fill the dialog.<br> Url: ```http://tubvsig-so2sat-vm1.srv.mwn.de/geoserver/ows?```<br>
