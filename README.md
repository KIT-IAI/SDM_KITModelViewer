...
* Building energy simulation using on [EnergyPlus™](https://github.com/NREL/EnergyPlus). Support for IDF and epJSON data sets, visualization of building geometry, display of parameters, simulation, and presentation of results.
