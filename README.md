...
* [Plugin SDK](https://github.com/KIT-IAI/SDM_Plugin_SDK) - Software development kit for plugin development 
...
[KITModelViewer](https://www.iai.kit.edu/ifc) is a Windows® freeware application developed by the [Semantic Data Models](https://www.iai.kit.edu/english/groups_1055.php) (SDM) working group at the [Institute for Automation and Applied Informatics](https://www.iai.kit.edu/english/) (IAI), [Karlsruhe Institute of Technology](https://www.kit.edu/english/) (KIT). It is used to visualize and analyze semantic data models from the fields of BIM (Building Information Modeling) and GIS (Geographic Information Systems). The focus is on open, standardized data formats.
...
## Features
* Standard functionality for displaying, navigating in and interacting with 3D models<br>
* Detailed presentation of attributes, property sets, relations and geometries<br>
* Synchronizing views for rotate, pan, and zoom across multiple models for visual inspection<br>
* Core SteamVR integration functionality, tested with HTC Vive and HP headsets<br>
...
* openBIM validation based on mvdXML, including creation and editing of mvdXML definitions<br>
...
* Style Rendering for example using XPlanGML Data: Conversion of raw GML geometries and interpretation of planning and legal provisions in land-use plans into symbols, hatch patterns, and boundaries signatures<br>
