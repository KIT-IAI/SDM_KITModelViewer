...
The KITModelViewer has its own SDK that enables the development of plugin extensions in C++. In addition, the software has a Python API that is an integral part of the KITModelViewer in the form of a plugin. The Python plugin is available as open source and can be extended using the [Plugin SDK](https://github.com/KIT-IAI/SDM_Plugin_SDK).
