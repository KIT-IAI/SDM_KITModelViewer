...
* Interactive object lists enable a direct link between the list and the 3D scene
  <img width="800" alt="InteractiveLists" src="https://github.com/user-attachments/assets/f49fda25-f650-414b-8b29-90a94778fe71" />
* Individual colour coding of objects based on attributes and properties
  <img width="800" alt="ColorCoding_u-Value" src="https://github.com/user-attachments/assets/fde0d293-5e5a-48a0-b3a3-556f2413f16e" />
